...
public record DadosListagemLivrosDTO(Long id, String nome, GeneroEnum genero, String autor, EditoraEnum editora, LocalDate lancamento) {
	
	public DadosListagemLivrosDTO(Livro livro) {
		this(livro.getId(), livro.getNome(), livro.getGenero(), livro.getAutor(), livro.getEditora(), livro.getLancamento());
	}
